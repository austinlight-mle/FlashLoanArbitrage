...
contract Arbitrage is IFlashLoanRecipient{
    ...
    function receiveFlashLoan(
        ...
        // We swap the flashAmount of tokenA and expect to get X amount of tokenB
        _swapOnV3(
            trade.routerPath[0],
            trade.tokenPath[0],
            flashAmount,
        ...
        // We swap the contract balance of tokenB and
        // expect to at least get the flashAmount of tokenA
        _swapOnV3(
            trade.routerPath[1],
            trade.tokenPath[1],
